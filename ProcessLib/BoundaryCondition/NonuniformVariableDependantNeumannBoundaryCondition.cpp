    ...
    unsigned const shapefunction_order, MeshLib::Mesh const& bulk_mesh)
{
    ...
    {
    OGS_FATAL("NonuniformVariableDependantNeumann BC only implemented for 2 variable processes.");
    }
    ...
    return std::make_unique<NonuniformVariableDependantNeumannBoundaryCondition>(
